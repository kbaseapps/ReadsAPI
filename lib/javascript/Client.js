...
function ReadsAPI(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_reads_info_all_formatted = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ReadsAPI.get_reads_info_all_formatted",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ReadsAPI.status",
